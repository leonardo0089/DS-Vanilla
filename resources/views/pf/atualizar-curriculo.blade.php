    ...
    <div class="containerFora">
        ...
        <div class="primeiroContainer">
            <div class="orientacao">
                <h2>Atualizar dados do CV</h2>
            </div>
            <div class="formulario">
                <form method="POST" action="{{ route('perfil.atualizandoCV') }}" >
                    {!! csrf_field() !!}
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" value="{{ $lista->telefone }}" class="form-control" onkeypress="mascara(this, '## #####-####')" maxlength="14" id="inputEmail4" name="cel">
                          </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <div >
                          <input class="form-control" value="{{ $lista->data_nasc }}" type="date" value="Coloque a data" id="example-date-input" name="nascimento">
                        </div>
                    </div>
                </div>
            ...
            <div class="formulario">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" value="{{ $lista->link_linkedin }}" class="form-control" id="inputEmail4" name="redeLink">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">Facebook</label>
                        <input type="text" value="{{ $lista->link_facebook }}" class="form-control" id="inputEmail4" name="redeFace">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">Twitter</label>
                        <input type="text" value="{{ $lista->link_twitter }}" class="form-control" id="inputEmail4" name="redeTW">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">Google+</label>
                        <input type="text" value="{{ $lista->link_google }}" class="form-control" id="inputEmail4" name="redeGoogle">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">YouTube</label>
                        <input type="text" value="{{ $lista->link_youtube }}" class="form-control" id="inputEmail4" name="redeYou">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">Instagram</label>
                        <input type="text" value="{{ $lista->link_insta }}" class="form-control" id="inputEmail4" name="redeInsta">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="inputEmail4">Blog</label>
                        <input type="text" value="{{ $lista->link_blog }}" class="form-control" id="inputEmail4" name="redeBlog">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="formulario">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" value="{{ $lista->instituicao }}" class="form-control" id="inputEmail4" name="instituicao">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" value="{{ $lista->formacao }}" class="form-control" id="inputEmail4" name="formacao">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <div >
                          <input class="form-control" type="date" value="{{ $lista->data_iniciof }}" id="example-date-input" name="data_inicio">
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <label>Conclusão</label>
                        <div >
                          <input class="form-control" type="date" value="{{ $lista->data_conclusao }}" id="example-date-input" name="conclusao_data">
                        </div>
                      </div>
                </div>
                <div class="form-row">
            ...
            <div class="formulario">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" value="{{ $lista->nome_empresa }}" class="form-control" id="inputEmail4" name="nome_empresa">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputEmail4">Cargo</label>
                      <input type="text" value="{{ $lista->cargo }}" class="form-control" id="inputEmail4" name="cargo">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Descrição das Atividades</label>
                        <textarea id="" cols="50" rows="5" name="atividadeE">{{ $lista->desc_atividades }}</textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Data Inicio</label>
                        <div >
                          <input class="form-control" type="date" value="{{ $lista->data_inicio }}" id="example-date-input" name="data_inicioE">
                        </div>
                      </div>
                      <div class="form-group col-md-4">
                        <label>Termino</label>
                        <div >
                          <input class="form-control" type="date" value="{{ $lista->data_inicio }}" id="example-date-input" name="termino">
                        </div>
                      </div>
                </div>
            </div>
