    ...
    <div class="container-postar-nova-vaga">
        <div class="container-interno-postar-vaga">
            ...
            <div class="formulario-nova-vaga">
              <form class="needs-validation" novalidate method="POST" action="{{ route('perfil.cadVaga') }}">
                {!! csrf_field() !!}
                    <div class="form-row">
                      <div class="col-md-11 mb-3">
                        <label for="validationCustom01">Titulo da Vaga:</label>
                        <input type="text" class="form-control" id="validationCustom01" required name="titulo_vaga">
                      ...
                      <div class="col-md-11 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" required name="esp_area">
                        <div class="valid-feedback">
                          Looks good!
                        </div>
                      </div>
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" required name="n_vagas">
                    ...
                    <div class="form-row">
                      <div class="col-md-8 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" required name="opt">
                        <div class="invalid-feedback">
                          Please provide a valid city.
                        </div>
                      </div>  
                    ...
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" required name="sal">
                        <div class="invalid-feedback">
                          Please provide a valid city.
                        </div>
                      </div>  
                    ...
                    <div class="form-row">
                      <div class="col-md-10 mb-3">
                        ...
                        <textarea class="form-control" name="beneficios" id="validationTextarea" rows="5" placeholder="Digite aqui os beneficios que sua empresa oferece." required></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" required name="horario">
                        <div class="invalid-feedback">
                          Please provide a valid city.
                        </div>
                      </div>  
                    ...
                    <div class="form-row">
                      <div class="col-md-10 mb-3">
                        ...
                        <textarea class="form-control" name="atividades" id="validationTextarea" rows="5" placeholder="Digite aqui as atividades que o funcionario ira exercer." required></textarea>
                        <div class="invalid-feedback">
                        Please enter a message in the textarea.
                        </div>
                      </div>  
                    ...
                    <div class="form-row">
                      <div class="col-md-10 mb-3">
                        ...
                        <textarea class="form-control" name="p_requisitos" id="validationTextarea" rows="5" placeholder="Digite aqui os pré requisitos que o funcionario devera ter." required></textarea>
                        <div class="invalid-feedback">
                        Please enter a message in the textarea.
                        </div>
                      </div>  
                    ...
                    <div class="form-row">
                      <div class="col-md-10 mb-3">
                        ...
                        <textarea class="form-control" name="exigencias" id="validationTextarea" rows="5" placeholder="Digite aqui suas exigencias." required></textarea>
                        <div class="invalid-feedback">
                        Please enter a message in the textarea.
                        </div>
                      </div>  
